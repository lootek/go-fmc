...
- BREAKING CHANGE: `login()` and `refresh()` functions are no longer exported
- Fix: Race conditions in authentication flow that could cause multiple concurrent authentications
